 ...
 *
 * **Новая вкладка со своими данными обязана попасть в сохранение персонажа.** Если
 * она добавляет столбцы к существующим таблицам — ничего делать не нужно, копия берёт
 * строку целиком. Если заводит свою таблицу — вписать её в `CharacterSheet`,
 * `CharacterRepository.saveCopy` и `sameAs`, иначе сохранение её потеряет.
 */
